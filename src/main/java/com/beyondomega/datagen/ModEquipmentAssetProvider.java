...
public class ModEquipmentAssetProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<EquipmentAsset>, EquipmentClientInfo> output) {
        output.accept(ModArmorMaterials.ZENITH_KEY, EquipmentClientInfo.builder()
                .addHumanoidLayers(Identifier.fromNamespaceAndPath(BeyondOmega.MOD_ID, "zenith"), false)
                .build());
    }
    ...
    public String getName() {
        return "Beyond Omega Equipment Definitions";
    }
}